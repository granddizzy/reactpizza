...
const Index: React.FC = () => {
    const {totalCount, totalPrice, items} = useSelector((state: State) => state.cart);
    ...
    return (
        <>
            ...
            <div className="cart__items">
                {items.map((cartItem: Item, index: number) => (
                    <div key={index} className="cart__item">
                        <div className="cart__item-img">
                            <img
                                className="pizza-block__image"
                                src={process.env.PUBLIC_URL + '/' + cartItem.imgUrl}
                                alt="Pizza"
                            />
                        </div>
                        <div className="cart__item-info">
                            <h3>{cartItem.title}</h3>
                            <p>{typesNames[cartItem.type]}, {cartItem.size} см.</p>
                        </div>
